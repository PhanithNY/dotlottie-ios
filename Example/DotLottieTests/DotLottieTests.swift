...
/// Minimal valid Lottie JSON: 60-frame, 30fps, 100×100 animation with a red rectangle shape.
...
/// Minimal dotLottie state machine JSON with a Boolean and Numeric input.
